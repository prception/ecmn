...
//       const parent = button.closest(".water-testing-parameters");
...
//       // Toggle text from .... to View Less or back
//       button.textContent = button.textContent === "...." ? "View Less" : "....";
//     });
//   });
// });
    ...
    button.addEventListener("click", function() {
      ...
      extraItems.forEach(item => {
        if (item.style.display === "none" || item.style.display === "") {
          item.style.display = item.tagName === "SPAN" ? "inline" : "inline-block";
        } else {
...
// For Download Button
document.querySelectorAll('.water-testing-download-option a.lab-btn').forEach(button => {
